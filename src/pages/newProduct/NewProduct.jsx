...
export default function NewProduct() {
  ...
  //Uploading item to firebase after uploading movie in our db
  const upload = (items) => {
    items.forEach((item) => {
      //To allow upload same image or movie
      const filename = new Date().getTime() + item.label + item.file.name;
      //Putting item in firebase storage
      const uploadTask = storage.ref(`/items/${filename}`).put(item.file);
      //Progess of uploading 
  ...
  //Finally sending data to database
